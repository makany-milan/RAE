* Find largest connected set of institutions
...
* install nwcommands package
* search nwcommands  -  install the .ado file
* ssc install nwcommands
keep aff_inst_id author_id
* keep one connection per author-institution pair
bys aff_inst_id author_id: keep if _n == 1 // 55,651 connections
...
cd "$data_folder"
capture mkdir "temp"
save "temp/largest_network", replace