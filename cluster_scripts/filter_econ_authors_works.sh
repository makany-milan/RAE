#!/bin/bash
#SBATCH --job-name=rae_filter_author_works                   # Job name
...
#SBATCH --time=24:00:00                                 # Time limit, estimated based on previous single core runs

# The time limit on this script may be a large overestimate
# Never executed this script with the new data structure

# Execute code
python3 /storage/economics/ecudpb/wia/scripts/openalex_scripts/filter.py --filter_econ_works --remote True